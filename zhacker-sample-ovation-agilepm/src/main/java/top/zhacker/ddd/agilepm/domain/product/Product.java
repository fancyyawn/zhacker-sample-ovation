...
import top.zhacker.ddd.agilepm.domain.product.blacklogitem.*;
import top.zhacker.ddd.agilepm.domain.product.discussion.ProductDiscussion;
import top.zhacker.ddd.agilepm.domain.product.discussion.ProductDiscussionInitiated;
import top.zhacker.ddd.agilepm.domain.product.discussion.ProductDiscussionRequested;
import top.zhacker.ddd.agilepm.domain.product.event.ProductBacklogItemPlanned;
import top.zhacker.ddd.agilepm.domain.product.event.ProductCreated;
import top.zhacker.ddd.agilepm.domain.product.event.ProductReleaseScheduled;
import top.zhacker.ddd.agilepm.domain.product.event.ProductSprintScheduled;
...
public class Product extends IdentifiedEntity {
    ...
    public void changeProductOwner(ProductOwner aProductOwner) {
        if (!this.productOwnerId().equals(aProductOwner.getProductOwnerId())) {
            this.setProductOwnerId(aProductOwner.getProductOwnerId());
    ...
    private void setProductOwnerId(ProductOwnerId aProductOwnerId) {
        ...
        this.assertArgumentEquals(this.tenantId(), aProductOwnerId.getTenantId(), "The productOwner must have the same tenant.");

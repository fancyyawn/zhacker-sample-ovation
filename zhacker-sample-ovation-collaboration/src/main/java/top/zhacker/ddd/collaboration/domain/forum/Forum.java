...
package top.zhacker.ddd.collaboration.domain.forum;
...
public class Forum extends EventSourcedRootEntity {
    ...
    public void moderatePost(
        ...
        this.assertArgumentEquals(aPost.getForumId(), this.forumId(), "Not a post of this forum.");
    ...
    public Discussion startDiscussion(
        ...
        return this.startDiscussionFor(anAuthor, aSubject, null);
    }
    ...
    public Discussion startDiscussionFor(
        ...
        Discussion discussion =
                new Discussion(
                    this.tenant(),
                    this.forumId(),
                    DomainRegistry.repo(DiscussionRepository.class).nextIdentity(),
                    anAuthor,
                    aSubject,
                    anExclusiveOwner);

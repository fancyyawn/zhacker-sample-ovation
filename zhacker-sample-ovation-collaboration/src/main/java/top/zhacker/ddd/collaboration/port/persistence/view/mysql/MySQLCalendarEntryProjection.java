...
public class MySQLCalendarEntryProjection
    ...
    @Autowired
    public MySQLCalendarEntryProjection(@Qualifier("parentEventStreamDispatcher") EventStreamDispatcher aParentEventDispatcher) {
        super();
    ...
    protected void when(CalendarEntryDescriptionChanged anEvent) throws Exception {
        ...
        statement.setString(2, anEvent.calendarEntryId().getId());
    ...
    protected void when(CalendarEntryRescheduled anEvent) throws Exception {
        ...
        statement.setString(8, anEvent.calendarEntryId().getId());
    ...
    throws Exception {
        ...
        statement.setString(2, aCalendarEntryId.getId());

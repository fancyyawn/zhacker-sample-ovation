...
public class EventStoreCalendarRepository
    ...
    protected EventStreamStore eventStore(){
    ...
    public Calendar calendarOfId(Tenant aTenant, CalendarId aCalendarId) {
        ...
        EventStreamId eventId = new EventStreamId(aTenant.getId(), aCalendarId.getId());
    ...
    public void save(Calendar aCalendar) {
        EventStreamId eventId =
                new EventStreamId(
                        aCalendar.tenant().getId(),
                        aCalendar.calendarId().getId(),
